...
from run_deployment import main## previously run_deployment now main
...
def main():
    ...
    if st.button("Predict"):
        ...
        st.success(
            "Your Customer Satisfactory rate(range between 0 - 5) \
            with given product details is :-{}".format(
                pred
                )
            )
